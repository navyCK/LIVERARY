...
public class ReceiveDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_message_receive_detail);
        ...
        detail_date.setText(messageItemArrayList.get(position).getNdate());
...
//                Toast.makeText(BoardDetailActivity.this,"이미지가 없는 글", Toast.LENGTH_SHORT).show();
        ...
        boardDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(ReceiveDetailActivity.this);
